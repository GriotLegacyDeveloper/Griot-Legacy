...
class GroupChatOptionDialog extends StatefulWidget {
  final GroupChatOptionDialogInterface mListener;
  ...
  const GroupChatOptionDialog({Key key, this.copyText, this.mListener, this.comeFrom, this.msgId, this.index, this.groupId}) : super(key: key);

  @override
  _GroupChatOptionDialogState createState() => _GroupChatOptionDialogState();
}




class _GroupChatOptionDialogState extends State<GroupChatOptionDialog> {
                ...
                children: <Widget>[
                  Visibility(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        widget.mListener.editTextFunction(widget.copyText,widget.msgId,widget.groupId);
                  ...
                  GestureDetector(
                    ...
                    onTap: (){
                      if(widget.mListener!=null){
                        widget.mListener.removeChat(widget.msgId,widget.index,widget.groupId);
                        Navigator.pop(context,false);
                      }
                    },
                    child: Row(
...
abstract class GroupChatOptionDialogInterface{
